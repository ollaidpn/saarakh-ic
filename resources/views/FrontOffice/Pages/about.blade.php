...
<main class="main">
    ...
    <section class="promo">
        <div class="promo-slider">
            <div class="promo-slider__item promo-slider__item--style-1">
                <picture>
                    <source srcset="{{ asset('assets/FrontOffice/img/promo_1.jpg')}}" media="(min-width: 835px)"/>
            ...
            <div class="promo-slider__item promo-slider__item--style-2">
                <picture>
                    <source srcset="{{ asset('assets/FrontOffice/img/promo_2.jpg')}}" media="(min-width: 835px)"/>
                    <source srcset="{{ asset('assets/FrontOffice/img/834promo_2.jpg')}}" media="(min-width: 376px)"/><img class="img--bg" src="{{ asset('assets/FrontOffice/img/375promo_2.jpg')}}" alt="img"/>
                </picture>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7">
    ...
    <!-- projects end-->
    <!-- events start-->
    <section class="section events"><img class="events__bg" src="{{ asset('assets/FrontOffice/img/events_bg.png')}}" alt="img"/>
        <div class="container">
            <div class="row margin-bottom">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/event_1.jpg')}}" alt="img"/></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/event_2.jpg')}}" alt="img"/></div>
                        <div class="event-item__content">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/event_3.jpg')}}" alt="img"/></div>
                        <div class="event-item__content">
                            <h6 class="event-item__title"><a href="#">Help for Language. Voluanteer</a></h6>
                            <p><b>Dark Spurt,</b> San Francisco, CA 94528, USA</p>
    ...
    <!-- events end-->
    <!-- text section start-->
    <section class="section text-section"><img class="text-section__bg" src="{{ asset('assets/FrontOffice/img/text-section.png')}}" alt="img"/>
        <div class="container">
            <div class="row">
    ...
    <!-- blog start-->
    <section class="section blog"><img class="blog__bg" src="{{ asset('assets/FrontOffice/img/blog_bg.png')}}" alt="img"/>
        <div class="container">
            <div class="row margin-bottom">
                <div class="col-12">
            ...
            <div class="row offset-margin">
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div class="blog-item blog-item--style-1">
                        <div class="blog-item__img"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/blog_1.jpg')}}" alt="img"/><span class="blog-item__badge" style="background-color: #49C2DF;">Water Delivery</span></div>
                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    <div class="blog-item blog-item--style-2"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/blog_2.png')}}" alt="img"/>
                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    <div class="blog-item blog-item--style-2"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/blog_3.png')}}" alt="img"/>
                ...
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div class="blog-item blog-item--style-1">
                        <div class="blog-item__img"><img class="img--bg" src="{{ asset('assets/FrontOffice/img/blog_4.png')}}" alt="img"/><span class="blog-item__badge" style="background-color: #F36F8F;">Medicine</span></div>
                        <div class="blog-item__content">
                            <h6 class="blog-item__title"><a href="#">Save the Children's Role in Fight Against Malnutrition Hailed</a></h6>
                            <p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento splittail canthigaster</p>
                            <div class="blog-item__details"><span class="blog-item__date">23 Jan' 19</span><span>
